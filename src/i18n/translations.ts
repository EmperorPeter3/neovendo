export const translations = {
  en: {
    ...
    "carFilters.engineVolume": "Engine volume (L)",
    "carFilters.liters": "L",
    ...
    "validation.engineVolumeRange": "Engine volume must be between 0 and 20 liters",
  ...
  pt: {
    ...
    "carFilters.engineVolume": "Cilindrada (L)",
    "carFilters.liters": "L",
    ...
    "validation.engineVolumeRange": "O volume do motor deve estar entre 0 e 20 litros",
  ...
  es: {
    ...
    "validation.engineVolumeRange": "El volumen del motor debe estar entre 0 y 20 litros",
  ...
  de: {
    ...
    "carFilters.engineHybrid": "Hybrid",
    "carFilters.engineVolume": "Hubraum (L)",
    "carFilters.liters": "L",
    ...
    "validation.engineVolumeRange": "Das Motorvolumen muss zwischen 0 und 20 Liter liegen",
  ...
  fr: {
    ...
    "carFilters.engineVolume": "Cylindrée (L)",
    "carFilters.liters": "L",
    ...
    "validation.engineVolumeRange": "Le volume du moteur doit être compris entre 0 et 20 litres",
  ...
  it: {
    ...
    "carFilters.engineVolume": "Cilindrata (L)",
    "carFilters.liters": "L",
    "carFilters.fuelConsumption": "Consumo (L/100km)",
    "carFilters.litersPer100km": "L/100km",
    ...
    "validation.engineVolumeRange": "Il volume del motore deve essere compreso tra 0 e 20 litri",
  ...
  ru: {
    ...
    "carFilters.engineVolume": "Объём двигателя (л)",
    "carFilters.liters": "л",
    ...
    "validation.engineVolumeRange": "Объём двигателя должен быть от 0 до 20 литров",
